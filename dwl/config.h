...
static const char *voldown[] = { "changevolume.sh", "low", NULL };
static const char *volmute[] = { "changevolume.sh", "muted", NULL };
static const char *editconf[] = { "editconfigs.sh", NULL };
static const char *screenshot[] = { "wscreenshot.sh", NULL };
